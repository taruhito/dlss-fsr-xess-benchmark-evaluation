...
- **Code** (e.g., scripts, source files, configs): licensed under **MIT**.  
  See [LICENSE-CODE](https://github.com/taruhito/dlss-fsr-xess-benchmark-evaluation/blob/master/LICENSE-CODE)
- **Non-code content** (e.g., thesis text, figures, benchmark datasets/results, documentation): licensed under **CC BY 4.0**.  
  See [LICENSE-CONTENT](https://github.com/taruhito/dlss-fsr-xess-benchmark-evaluation/blob/master/LICENSE-CONTENT)
